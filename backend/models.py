...
from sqlalchemy import Boolean, Column, String, Text, DateTime, ForeignKey, LargeBinary, func
...
class Todo(Base):
    """A to-do item on a user's starbot list. Usually generated by the chat from
    emails/calendar (source + source_link point back at the origin), but users
    can also add items by hand."""
