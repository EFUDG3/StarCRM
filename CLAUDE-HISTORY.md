# Star CRM - Project History Archive

This file contains the session-by-session development history of Star CRM / Starbot,
moved here from CLAUDE.md to keep the main project file focused on current architecture
and active work. Everything here is completed, deployed, or resolved.

If you need context on WHY a decision was made, HOW a feature was built, or WHAT was
tried and discarded, search this file by date or topic.

Organized reverse-chronologically (newest first), matching the order they were written.

---

## Session notes and deploy logs
...
## Legacy deploy instructions (Cloud Run + Neon, replaced by Azure Container Apps)
...
## Feature state snapshot (mid-2026, outdated)
...
## Connector OAuth: the run.app blocker (RESOLVED via custom domain 2026-07-15)
